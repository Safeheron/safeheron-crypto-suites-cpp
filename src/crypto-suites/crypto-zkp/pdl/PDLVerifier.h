#ifndef SAFEHERONCRYPTOSUITES_PDLVERIFIER_H
#define SAFEHERONCRYPTOSUITES_PDLVERIFIER_H
...
class PDLVerifier {
public:
    PDLVerifier(): is_initialized_(false) {}
...
#endif //SAFEHERONCRYPTOSUITES_PDLVERIFIER_H