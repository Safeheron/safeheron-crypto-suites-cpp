#ifndef SAFEHERONCRYPTOSUITES_PDLPROVER_V2_H
#define SAFEHERONCRYPTOSUITES_PDLPROVER_V2_H
...
class PDLProver_V2 {
public:
    PDLProver_V2(): is_initialized_(false) {}
...
#endif //SAFEHERONCRYPTOSUITES_PDLPROVER_V2_H