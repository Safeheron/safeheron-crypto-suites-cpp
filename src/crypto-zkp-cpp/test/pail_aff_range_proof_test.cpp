...
TEST(ZKP, Pail_ENC_Range_Proof_2)
{
    ...
    safeheron::zkp::pail::PailAffRangeSetUp setup(N_tilde, h1, h2);
    safeheron::zkp::pail::PailAffRangeStatement statement(c1, c2, pail_pub, curv->n);
    safeheron::zkp::pail::PailAffRangeWitness witness(x, y, r);

    CTimer timer("time_cost_of_proof");
    safeheron::zkp::pail::PailAffRangeProof range_proof;
    ...
    safeheron::zkp::pail::PailAffRangeProof range_proof2;
