...
TEST(ZKP, Pail_ENC_Range_Proof_3)
{
    ...
    safeheron::zkp::pail::PailEncGroupEleRangeSetUp setup(N_tilde, h1, h2);
    safeheron::zkp::pail::PailEncGroupEleRangeStatement statement(c, pail_pub.n(), pail_pub.n_sqr(), curv->n, X, g, 256, 512);
    safeheron::zkp::pail::PailEncGroupEleRangeWitness witness(x, r);
